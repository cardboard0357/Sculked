...
execute if block ~ ~-1 ~ #minecraft:sculk_replaceable run setblock ~ ~-1 ~ sculk replace
execute unless block ~ ~-1 ~ sculk unless block ~ ~-1 ~ sculk_vein unless block ~ ~-1 ~ air unless block ~ ~-1 ~ #minecraft:sculk_replaceable run setblock ~ ~ ~ sculk_vein[down=true] keep
...
particle sculk_soul ~ ~0.5 ~ 0.1 0.6 0.1 0.1 1 force